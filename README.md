...
<h2>Test it now</h2>
<p><b><a href="http://jsbin.com/bullframecss-1.4.0-branch/latest/quiet" title="bullframe demo page - JSBin">Check out the demo</a></b><br>
Play with HTML/CSS code on JSBin <a href="http://jsbin.com/bullframecss-1.4.0-branch/latest/edit" title="bullframe demo page - JSBin">http://jsbin.com/bullframecss-1.4.0-branch/latest/edit</a></p>
...
<ul>
  ...
  <li>Firefox 4+
  <li>Safari 4+
  <li>Opera 10+ <i>(responsive tables not working in v10-11)</i></li>
</ul>
<ul>
  <li>Mobile Safari 5+
  <li>Android browser 2.3+
  <li>Latest Opera Mobile <i>(responsive tables not working)</i></li>
  <li>Opera Mini <i>(mark element is buggy and responsive videos/tables not working)</i></li>
