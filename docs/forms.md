...
```html
<input type="checkbox" id="checkbox1" /> <label for="checkbox1">Checkbox label</label>
```
...
```html
<input type="text" disabled placeholder="Disabled input" /> <button disabled>Disabled button</button>
```
