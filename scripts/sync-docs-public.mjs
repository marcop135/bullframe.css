...
await cp('src/docs/kitchen-sink/index.html', 'docs/public/kitchen-sink/index.html', { force: true });
await cp('src/docs/kitchen-sink/css', 'docs/public/kitchen-sink/css', { recursive: true, force: true });
await cp('src/docs/kitchen-sink/icons', 'docs/public/kitchen-sink/icons', { recursive: true, force: true });
