...
- [Grid System](/docs/utilities/grid) - 12-column responsive grid
- [Spacing](/docs/utilities/spacing) - Margin and padding utilities
- [Text](/docs/utilities/text) - Typography utilities
...
<div class="bf-invisible">Invisible</div>
<div class="bf-hidden">Hidden</div>
